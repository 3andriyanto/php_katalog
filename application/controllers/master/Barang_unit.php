...
class Barang_unit extends MY_Controller {

    function __construct() {
        parent::__construct();

        $this->kode_transaksi = "BARANG_UNIT";
        ...
        $this->fields = array(
            ...
            "nama_unit" => array("TIPE" => "STRING", "LABEL" => "Unit"),
...
//    public function upload() {
//        $image_path = './asset/image/produk_unit/';
//        $thumb_path = './asset/image/produk_unit/thumb/';
//
...
//            
//            $filename = $_POST["nama_barang_unit"];
//            //$filename = $this->input->post("nama_barang_unit");
