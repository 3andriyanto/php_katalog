            ...
            <div class="box">
                ...
                <div class="box-body">
                    <button class="btn btn-sm btn-success" onclick="tambah()" style="margin-bottom: 10px;"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
                        <table id="table_user" class="display responsive table table-bordered table-hover" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>Nama</th>
                    ...
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select id="role" name="role" class="form-control selectpicker" data-live-search="true" data-container="#modal_form">
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#password').hide();
                $('[name="role"]').val(data.id_role).trigger('change');
                ...
                foto = data.photo === '' ? 'no_photo.png' : data.photo;
                image_url = '{base_url}asset/image/user/' + foto;
                foto_user = foto;
                $.get(image_url)
                        .done(function () {
    ...
    function simpan() {
        ...
        if (document.getElementById('photo').files.length !== 0) {
            ...
            $.ajax({
                url: "{base_url}master/user/upload",
                type: "POST",
                data: formData,
                async: false,
                success: function (data) {
    ...
    function hapusGambar(photo) {
        $success = false;
        if (photo !== 'no_photo.png') {
            $.ajax({
                url: "{base_url}master/user/delete_file/" + photo,
                type: "POST",
                async: false,
                success: function (data) {
                    $success = true;
